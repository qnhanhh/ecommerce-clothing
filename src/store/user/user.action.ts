...
import { Action, createAction } from "../../utils/reducer/reducer.utils";
import { AdditionInformation, UserData } from '../../utils/firebase/firebase.utils';
...
export type SignUpSuccess = ActionWithPayload<USER_ACTION_TYPES.SIGN_UP_SUCCESS, { user: UserData, additionalDetails: AdditionInformation }>
...
export const signUpSuccess = withMatcher((user: UserData, additionalDetails: AdditionInformation): SignUpSuccess =>
